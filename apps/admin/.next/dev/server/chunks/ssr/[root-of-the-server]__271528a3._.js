...
function loadEnv(filePath) {
    ...
    const content = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(filePath, "utf8").replace(/^\uFEFF/, "");
...
const triedPaths = [
    __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].resolve(process.cwd(), ".env"),
    __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].resolve(process.cwd(), ".env.local"),
    __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].resolve(process.cwd(), "../../.env"),
    __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].resolve(process.cwd(), "../../.env.local")
];
for (const envPath of triedPaths){
    loadEnv(envPath);
}
const databaseUrl = process.env.DATABASE_URL;
if (typeof databaseUrl !== "string" || !databaseUrl.trim()) {
    throw new Error(`DATABASE_URL is missing for admin app Prisma client. Checked: ${triedPaths.join(", ")}`);
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__271528a3._.js.map